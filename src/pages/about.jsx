...
return (
    ...
    <div className="max-w-[50rem] mx-auto px-4 py-8 text-base leading-6 text-white">
        ...
        <h3 className="font-bold text-lg mt-2 p-2">What's AniPrime.?</h3>
        <p className="mt-2 p-2">
            AniPrime is an anime streaming site where you can watch anime online
            in HD quality with English subtitles or dubbing. You can also
            download any anime you want without registration.
          </p>
        </div>
        <div className="mb-4 p-2">
          <h3 className="font-bold text-lg">Is AniPrime safe?</h3>
          <p className="mt-2">
        ...
        <div >
          <h3 className="font-bold text-lg p-2">Why AniPrime?</h3>
          <p className="mt-2 p-2">
          ...
          <p className="mt-2 p-2">
            <strong>Device Compatibility:</strong> AniPrime works seamlessly on both{' '}
